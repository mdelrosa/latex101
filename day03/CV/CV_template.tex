...
%\address{425 University ave, Apt 5, Davis, CA 95616} % Your address
%\address{123 Pleasant Lane \\ City, State 12345} % Your secondary addess (optional)
%\address{530-760-8768 \\ hdchamain@ucdavis.edu} % Your phone number and email
...
%		& Limited experience with Verilog\\
%		Libraries/Deep learning frameworks & OpenCV, Sci-kit learn, Tensorflow/keras, Pytorch \\
%		Codecs & \\
		Languages: & English
	\end{tabular}
\end{rSection}
...
%-----------------------------------------------------------------------
\vspace*{-2mm}
\begin{rSection}{Relevant Publications\hspace*{65mm} }%\small Google Scholar: Lahiru D. Chamain}
